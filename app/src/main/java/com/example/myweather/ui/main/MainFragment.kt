...
class MainFragment : Fragment() {
    ...
    private class MainHolder(itemBinding: WeatherCityItemBinding) : RecyclerView.ViewHolder(itemBinding.root) {

        val _binding : WeatherCityItemBinding = itemBinding

        fun bind(weather : Weather) {
            _binding.weather = weather
        }
